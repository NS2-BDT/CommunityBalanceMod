...
local onCol = Color(0.4, 0.4, 1, 1)
local warningCol = Color(1, 0.6, 0)
local warningPoint = 0.7

local heatOffCol = Color(0.3, 0.3, 0.3)
local heatOnCol = Color(0.7, 0.6, 0)
local heatCombatCol = Color(0.7, 0.2, 0)
