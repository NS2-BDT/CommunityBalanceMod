...
function GetIsBuildLegal(techId, position, angle, snapRadius, player, ignoreEntity, ignoreChecks)
    ...
    -- prevent from placing structures half into walls/objects.
    if legalBuild and techId == kTechId.Shell 
     or legalBuild and techId == kTechId.Spur
     or legalBuild and techId == kTechId.Veil 
     or legalBuild and techId == kTechId.Crag
     or legalBuild and techId == kTechId.Shift
