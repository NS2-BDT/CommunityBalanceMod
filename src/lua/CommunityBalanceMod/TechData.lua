...
function BuildTechData()
    ...
    local techData =
    {
        ...
        {
            [kTechDataId] = kTechId.ShieldBatteryUpgrade,
            [kTechDataCostKey] = kShieldBatteryUpgradeCost,
            [kTechIDShowEnables] = false,
            [kTechDataResearchTimeKey] = kShieldBatteryResearchTime,
            [kTechDataHotkey] = Move.A,
            [kTechDataDisplayName] = "BATTERY_SHIELD",
            [kTechDataTooltipInfo] = "BATTERY_SHIELD_TOOLTIP",
        },
		
		{ 
            [kTechDataId] = kTechId.ShieldBattery,
            [kTechDataSupply] = kShieldedSentryBatterySupply,
            [kTechDataHint] = "BATTERY_SHIELD_HINT",
            [kTechDataGhostModelClass] = "MarineGhostModel",
            [kTechDataMapName] = ShieldedSentryBattery.kMapName,
            [kTechDataDisplayName] = "BATTERY_SHIELD",
            [kTechDataPointValue] = kShieldedSentryBatteryPointValue,
            [kTechDataModel] = ShieldedSentryBattery.kModelName,
            [kTechDataEngagementDistance] = 2,
            [kTechDataMaxHealth] = kShieldedSentryBatteryHealth,
            [kTechDataMaxArmor] = kShieldedSentryBatteryArmor,
            [kTechDataTooltipInfo] = "BATTERY_SHIELD_TOOLTIP",
            [kTechDataHotkey] = Move.S,
            [kTechDataNotOnInfestation] = kPreventMarineStructuresOnInfestation,
