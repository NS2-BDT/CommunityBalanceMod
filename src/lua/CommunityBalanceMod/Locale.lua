...
if Client then
    ...
    Locale.substitutions["FORTRESS_CRAG_TOOLTIP"] = "Triple the HP, moves up to 60% slower off infestation, able to cast Healwave without a Crag Hive. Limited to one Fortress Crag at the same time."
    ...
    Locale.substitutions["FORTRESS_SHIFT_TOOLTIP"] = "Triple the HP, moves up to 60% slower off infestation, able to cast Echo without a Shift Hive. Limited to one Fortress Shift at the same time."
    ...
    Locale.substitutions["FORTRESS_SHADE_TOOLTIP"] = "Triple the HP, moves up to 60% slower off infestation, able to cast Ink without a Shade Hive. Limited to one Fortress Shade at the same time."
    ...
    Locale.substitutions["FORTRESS_WHIP_TOOLTIP"] = "Triple the HP, moves up to 40% slower off infestation. Limited to one Fortress Whip at the same time."
