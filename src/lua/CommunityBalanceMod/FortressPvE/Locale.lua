if Client then
    ...
    Locale.substitutions["FORTRESS_CRAG_TOOLTIP"] = "Triple the HP, moves 40% slower, able to cast Healwave without a Crag Hive. Limited to one Fortress Crag at the same time."
    ...
    Locale.substitutions["FORTRESS_WHIP_TOOLTIP"] = "Triple the HP, moves 40% slower. Limited to one Fortress Whip at the same time."
    Locale.substitutions["FORTRESS_WHIP"] = "Fortress Whip"
    Locale.substitutions["FORTRESS_WHIP_UPGRADE"] = "Upgrade to Fortress Whip"
    Locale.substitutions["FORTRESS_WHIP_UPGRADE_TOOLTIP"] = "Triple the HP, moves 40% slower. Limited to one Fortress Whip at the same time."
