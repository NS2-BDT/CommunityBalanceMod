...
Script.Load("lua/CommunityBalanceMod/DIS.lua")
...
--Script.Load("lua/CommunityBalanceMod/ModularExos/ExoWeapons/MarineStructureAbility.lua")

Script.Load("lua/CommunityBalanceMod/Exo.lua")
Script.Load("lua/CommunityBalanceMod/Weapons/ModularExo_Data.lua")
Script.Load("lua/CommunityBalanceMod/NetworkMessages.lua")
