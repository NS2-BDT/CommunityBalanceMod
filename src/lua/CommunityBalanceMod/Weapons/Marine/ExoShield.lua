...
Script.Load("lua/CommunityBalanceMod/ModularExos/ExoWeapons/ShieldProjectorMixin.lua")
...
function ExoShield:OnUpdateRender()
    ...
    if parent and parent:GetIsLocalPlayer() then
        ...
        if not heatDisplayUI then
            ...
            heatDisplayUI:Load("lua/CommunityBalanceMod/ModularExos/GUI/GUI" .. self:GetExoWeaponSlotName():gsub("^%l", string.upper) .. "ShieldDisplay.lua")
