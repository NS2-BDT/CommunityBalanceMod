...
Script.Load("lua/CommunityBalanceMod/Weapons/PlasmaBallT1.lua")
Script.Load("lua/CommunityBalanceMod/Weapons/PlasmaBallT2.lua")
Script.Load("lua/CommunityBalanceMod/Weapons/PlasmaBallT3.lua")
...
function PlasmaLauncher:OnUpdateRender()
    ...
    if parent and parent:GetIsLocalPlayer() then
        ...
        if not chargeDisplayUI then
            ...
            chargeDisplayUI:Load("lua/CommunityBalanceMod/GUI" .. self:GetExoWeaponSlotName():gsub("^%l", string.upper) .. "PlasmaDisplay.lua")
