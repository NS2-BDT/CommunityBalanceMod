...
Script.Load("lua/CommunityBalanceMod/Others/Scripts/GUIBetaBalanceChangelog.lua")
Script.Load("lua/GUI/GUIText.lua")
Script.Load("lua/GUI/GUIParagraph.lua")
Script.Load("lua/CommunityBalanceMod/Others/Scripts/GUIBetaBalanceChangelogData.lua")
