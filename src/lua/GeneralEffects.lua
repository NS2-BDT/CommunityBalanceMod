...
--]]
    ...
    spawn =
    {
        spawnEffects =
        {
			...
			{cinematic = "cinematics/marine/structures/spawn_building.cinematic", classname = "CargoGate", done = true},
        ...
        spawnSoundEffects =
        {
			...
			{sound = "sound/NS2.fev/marine/structures/generic_spawn", classname = "CargoGate", done = true},
    ...
    deploy =
    {
        deploySoundEffects =
        {
			...
			{sound = "sound/NS2.fev/marine/structures/phasegate_deploy", classname = "CargoGate", done = true},
